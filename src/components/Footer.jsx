...
const Footer = () => {
  return (
 <footer id="contact" className="py-5 bg-neutral-900 text-center">
                <div className="container px-4">
                    <h2 className="display-4 fw-extrabold mb-5">Let's Connect</h2>
                    <div className="d-flex justify-content-center g-3">
                        <a href="https://github.com/rohitThakkar07" target='_black' className="custom-btn">
                        ...
                        <a target='_black' href="https://www.linkedin.com/in/rohitthakkar25/" className="custom-btn">
